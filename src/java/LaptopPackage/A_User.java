...
public class A_User extends HttpServlet {
@Override
...
"          </div>"
         ...
         out.println("</div>"); 
           out.println("</div>"); 
            List<User> list=AdminDao.getAllUser();
            
            out.println("<table border=1 width=100% style='border-color:#0047AB; background-color:#b2d0f9;' >");
            out.println("<h2 style='text-decoration:none; color:#123C69; '>USERS<hr></h2>");
            out.println("<th>Edit</th><th>Delete</th><th>EMAIL ID</th><th>NAME</th><th>NUMBER</th><th>PASSWORD</th><th>ADDRESS</th><th>PINCODE</th><th>STATE</th>");
           
            for (User u : list) {
                out.println("<tr><td><a class='link' href='A_UserEdit?id="+u.getemail()+"'>Edit</a></td><td><a class='link' href='A_UserDel?id="+u.getemail()+"'>Delete</a></td><td>"+u.getemail()+"</td><td>"+u.getn()+"</td><td>"+u.getnum()+"</td><td>"+u.getpass()+"</td><td>"+u.getadd()+"</td><td>"+u.getpin()+"</td><td>"+u.getstate()+"</td></tr>");
            }
                out.println("</table>");}}}
